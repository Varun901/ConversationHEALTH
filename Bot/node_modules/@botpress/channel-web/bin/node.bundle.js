...
module.exports = function () {
  var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee9(bp, config) {
    ...
    var diskStorage, upload, awsConfig, s3, s3Storage, knex, _db, listConversations, getConversation, appendUserMessage, getOrCreateRecentConversation, _ref2, getOrCreateUser, router, asyncApi, pkg, modulePath, staticFolder, validateUserId;
